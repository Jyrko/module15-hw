...
btn.addEventListener("click", () => {
  ...
  if (clicked) {
  btn.innerHTML = `
    <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-arrow-down-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  btn.innerHTML = `
    <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-arrow-down-left-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
